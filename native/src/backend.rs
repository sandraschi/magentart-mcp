...
const BACKEND_NAME: &str = "magentart-mcp-backend.exe";
const BACKEND_PORT: u16 = 10899;
const BACKEND_TAG: &str = "magentart-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "MAGENTART_MCP_PORT";
const ENV_HOST: &str = "MAGENTART_MCP_HOST";
const ENV_TAURI: &str = "MAGENTART_MCP_TAURI";
